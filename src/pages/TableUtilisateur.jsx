...
function TableUtilisateur() {
  ...
  const addSolde = async (e) => {
    ...
    try {
      const res = await axios.post(
        `http://13.48.104.124:8081/admin/alimenter/${currentItem.id}?montant=${montant}`,
        {},
  ...
  const blockItem = async (id) => {
    try {
      const res = await axios.put(
        `http://13.48.104.124:8081/admin/block/${id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      console.log(res.data);
    } catch (error) {
  ...
  const unblockItem = async (id) => {
    try {
      const res = await axios.put(
        `http://13.48.104.124:8081/admin/unblock/${id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      console.log(res.data);
    } catch (error) {
  ...
  const updateData = async (id, e) => {
    ...
    try {
      const res = await axios.put(
        `http://13.48.104.124:8081/admin/${id}/role/?role=${updateItem.role}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      console.log(res.data);
    } catch (error) {
