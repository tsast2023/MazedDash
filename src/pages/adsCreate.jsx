...
const publishNow = async () => {
  ...
  try {
      const res = await axios.post(
          "http://192.168.0.102:8081/api/annonce/createAnnonce",
  ...
  const scheduledAds = async () => {
    try {
      const res = await axios.post(
        `http://192.168.0.102:8081/api/annonce/planifier?contenu=${contenu}&type=${type}&description=${description}&datePublication=${datePublication}`,
        {},
