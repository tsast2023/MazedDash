...
const publishNow = async () => {
  ...
  try {
      const res = await axios.post(
          "http://13.48.104.124:8081/api/annonce/createAnnonce",
  ...
  const scheduledAds = async () => {
    try {
      const res = await axios.post(
        `http://13.48.104.124:8081/api/annonce/planifier?contenu=${contenu}&type=${type}&description=${description}&datePublication=${datePublication}`,
        {},
