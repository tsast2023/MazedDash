  ...
  const updateBid = async (id) => {
    ...
    if (data.contractEnchereEnid) {
      formData.append('contractEnchereEnid', data.contractEnchereEnid);
          ...
          const res = await axios.put(`http://13.48.104.124:8081/api/bid/${id}`, formData, {
...
//               "http://13.48.104.124:8081/api/bid/publishBidNow",
//               formData,
//               {
//                   headers: {
...
//           // Send the request with FormData
//           const res = await axios.post(
//               "http://13.48.104.124:8081/api/bid/scheduleBidPublication",
//               formData,
//               {
//                   headers: {
//                       Authorization: `Bearer ${token}`,
...
//   };
  ...
  const handleDeleteValue = (index) => {
    ...
    const demandeEnchereEdit = async()=>{
        try {
            const res = await axios.put(`http://13.48.104.124:8081/api/demandes/createModificationEnchereRequest` , {});
            console.log(res.data)
        } catch (error) {
            console.log(error)
        }
