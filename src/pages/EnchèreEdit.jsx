...
function EnchèreEdit(props) {
  ...
  const addBid = async () => {
      try {
          ...
          const res = await axios.post("http://192.168.0.103:8081/api/bid/createBrouillon", updatedData, {
  ...
  const addBidConfig = async () => {
      try {
          ...
          const res = await axios.post(
              "http://192.168.0.103:8081/api/bid/publishBidNow",
              formData,
              {
                  headers: {
  ...
  const addScheduledbid = async (e) => {
      ...
      try {
          ...
          // Send the request with FormData
          const res = await axios.post(
              "http://192.168.0.103:8081/api/bid/scheduleBidPublication",
              formData,
              {
                  headers: {
                      Authorization: `Bearer ${token}`,
