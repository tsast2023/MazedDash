...
const traiterDemandeCategory = async(demandeId , status)=>{
  try {
    ...
    const res = await axios.post(`http://192.168.0.101:8081/api/demandes/traiterDemandeModificationCategorie?demandeId=${demandeId}&statusDemande=${status}`,{}, {headers : {Authorization: `Bearer ${token}`}})
