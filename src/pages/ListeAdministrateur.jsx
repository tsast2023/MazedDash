...
try {
    const res = await axios.put(`http://13.48.104.124:8081/admin/block/${id}` , {headers : {Authorization: `Bearer ${token}`}});
...
try {
  const res = await axios.put(`http://13.48.104.124:8081/admin/unblock/${id}` , {headers : {Authorization: `Bearer ${token}`}});
    console.log(res.data)
} catch (error) {
  console.log(error)
}
...
const updateRole = async(id , e) =>{
  ...
  try {
    const res = await axios.put(`http://13.48.104.124:8081/admin/${id}/${role}` , {headers : {Authorization: `Bearer ${token}`}});
    console.log(res.data);
  } catch (error) {
    console.log(error)
  }
