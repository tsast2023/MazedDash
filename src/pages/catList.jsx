...
const deleteC = async(id) =>{
  try {
    const res = await axios.delete(`http://192.168.2.104:8081/api/categories/${id}` ,{headers : {Authorization: `Bearer ${token}`} });
  ...
  const banC = async(id) =>{
    if (user.roleAdmin.name === "Super admin") {
      try {
        const res = await axios.patch(`http://192.168.2.104:8081/api/categories/${id}/deactivate` ,{},{headers : {Authorization: `Bearer ${token}`} });
        console.log(res.data);
      } catch (error) {
        console.log(error)
      }
      ...
      try {
        const res = await axios.post(`http://192.168.2.104:8081/api/demandes/changerStatutCategorie?categoryId=${id}&newStatus=DESACTIVER` ,{},{headers : {Authorization: `Bearer ${token}`} });
        console.log(res.data);
      } catch (error) {
        console.log(error)
      }
  ...
  const unbanC = async(id) =>{
    if (user.roleAdmin.name === "Super admin") {
      try {
        const res = await axios.patch(`http://192.168.2.104:8081/api/categories/${id}/activate` ,{},{headers : {Authorization: `Bearer ${token}`} });
        console.log(res.data);
      } catch (error) {
        console.log(error)
      }
      ...
      try {
        const res = await axios.post(`http://192.168.2.104:8081/api/demandes/changerStatutCategorie?categoryId=${id}&newStatus=ACTIVER` ,{},{headers : {Authorization: `Bearer ${token}`} });
        console.log(res.data);
      } catch (error) {
        console.log(error)
      }
...
const alune = async(id)=>{
  try {
    console.log("done")
    const res = await axios.patch(`http://192.168.2.104:8081/api/categories/${id}/set-al-une?alUne=true` ,{headers : {Authorization: `Bearer ${token}`} });
    console.log(res.data);
...
const aluneFalse = async(id)=>{
  try {
    const res = await axios.patch(`http://192.168.2.104:8081/api/categories/${id}/set-al-une?alUne=false` ,{headers : {Authorization: `Bearer ${token}`} });
    console.log(res.data);
  ...
  if (user.roleAdmin.name === "Super admin") {
    try {
      const res = await axios.put(
        `http://192.168.2.104:8081/api/categories/${id}`, 
        category, 
    ...
    try {
      ...
      const res = await axios.post(
        `http://192.168.2.104:8081/api/demandes/createModificationCategoryRequest`, 
        category, 
        { 
